...
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Data exploration visualization code goes here.}
        ...
        \PY{c+c1}{\PYZsh{} show an image and its corresponding label}
        \PY{n}{index} \PY{o}{=} \PY{n}{random}\PY{o}{.}\PY{n}{randint}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{n+nb}{len}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)}\PY{p}{)}
        ...
        \PY{c+c1}{\PYZsh{} show the corresponding distribution of labels}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
        \PY{n}{plt}\PY{o}{.}\PY{n}{hist}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)}\PY{p}{;}
        \PY{n}{plt}\PY{o}{.}\PY{n}{title}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Traffic sign label histogram in training set}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
        \PY{n}{plt}\PY{o}{.}\PY{n}{xlabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Label}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
        \PY{n}{plt}\PY{o}{.}\PY{n}{ylabel}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Count}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
...
the first step of your project.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Preprocess the data here. It is required to normalize the data. Other preprocessing steps could include }
        ...
        \PY{n}{X\PYZus{}train\PYZus{}gray} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{X\PYZus{}valid\PYZus{}gray} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        \PY{n}{X\PYZus{}test\PYZus{}gray} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        
        
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{)}\PY{p}{)}\PY{p}{:}
            \PY{n}{X\PYZus{}train\PYZus{}gray}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{color}\PY{o}{.}\PY{n}{rgb2gray}\PY{p}{(}\PY{n}{X\PYZus{}train}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)} 
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}valid}\PY{p}{)}\PY{p}{)}\PY{p}{:}
            \PY{n}{X\PYZus{}valid\PYZus{}gray}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{color}\PY{o}{.}\PY{n}{rgb2gray}\PY{p}{(}\PY{n}{X\PYZus{}valid}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)} 
        \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{)}\PY{p}{)}\PY{p}{:}
            \PY{n}{X\PYZus{}test\PYZus{}gray}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{color}\PY{o}{.}\PY{n}{rgb2gray}\PY{p}{(}\PY{n}{X\PYZus{}test}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)} 
        
        \PY{k}{del} \PY{n}{X\PYZus{}train}\PY{p}{,} \PY{n}{X\PYZus{}valid}\PY{p}{,} \PY{n}{X\PYZus{}test}
        \PY{n}{X\PYZus{}train\PYZus{}gray} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}gray}\PY{p}{)}
        \PY{n}{X\PYZus{}valid\PYZus{}gray} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{X\PYZus{}valid\PYZus{}gray}\PY{p}{)}
        \PY{n}{X\PYZus{}test\PYZus{}gray} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{X\PYZus{}test\PYZus{}gray}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} normalized to +/\PYZhy{} 0.5}
        \PY{n}{X\PYZus{}train\PYZus{}gray} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mf}{0.5} \PY{o}{+} \PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}gray} \PY{p}{)}\PY{p}{;}
        \PY{n}{X\PYZus{}valid\PYZus{}gray} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mf}{0.5} \PY{o}{+} \PY{p}{(}\PY{n}{X\PYZus{}valid\PYZus{}gray}\PY{p}{)}\PY{p}{;}
        \PY{n}{X\PYZus{}test\PYZus{}gray} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mf}{0.5} \PY{o}{+}\PY{p}{(}\PY{n}{X\PYZus{}test\PYZus{}gray}\PY{p}{)}\PY{p}{;}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}\PY{p}{;}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{X\PYZus{}train\PYZus{}gray}\PY{p}{[}\PY{n}{index}\PY{p}{]}\PY{o}{.}\PY{n}{squeeze}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{cmap} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{gray}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Define your architecture here.}
        \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed}
        \PY{c+c1}{\PYZsh{} I will use a structure similar to lenet}
        ...
        \PY{n}{LAYER1\PYZus{}SIZE} \PY{o}{=} \PY{l+m+mi}{38}
        \PY{n}{LAYER2\PYZus{}SIZE} \PY{o}{=} \PY{l+m+mi}{64}
        \PY{n}{LAYER3\PYZus{}SIZE} \PY{o}{=} \PY{l+m+mi}{400}
        \PY{k}{def} \PY{n+nf}{LeNet}\PY{p}{(}\PY{n}{x}\PY{p}{)}\PY{p}{:}    
            ...
            \PY{c+c1}{\PYZsh{} from the input\PYZhy{}putput, weight should be 5x5x6}
            \PY{n}{conv1\PYZus{}stride} \PY{o}{=} \PY{l+m+mi}{1}
            \PY{n}{conv1\PYZus{}W} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{n}{shape}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{,}\PY{n}{LAYER1\PYZus{}SIZE}\PY{p}{)}\PY{p}{,} \PY{n}{mean} \PY{o}{=} \PY{n}{mu}\PY{p}{,} \PY{n}{stddev} \PY{o}{=} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv1\PYZus{}b} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{n}{LAYER1\PYZus{}SIZE}\PY{p}{]}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv1} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{conv2d}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{conv1\PYZus{}W}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{conv1\PYZus{}stride}\PY{p}{,} \PY{n}{conv1\PYZus{}stride}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{padding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{VALID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{o}{+} \PY{n}{conv1\PYZus{}b}
        
            \PY{c+c1}{\PYZsh{} TODO: Activation.}
            \PY{n}{conv1} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{relu}\PY{p}{(}\PY{n}{conv1}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} TODO: Pooling. Input = 28x28xLAYER1\PYZus{}SIZE. Output = 14x14xLAYER1\PYZus{}SIZE.}
            ...
            \PY{c+c1}{\PYZsh{} TODO: Layer 2: Convolutional. Output = 10x10xLAYER2\PYZus{}SIZE.}
            \PY{n}{conv2\PYZus{}stride} \PY{o}{=} \PY{l+m+mi}{1}
            \PY{n}{conv2\PYZus{}W} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{n}{shape}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,} \PY{n}{LAYER1\PYZus{}SIZE}\PY{p}{,} \PY{n}{LAYER2\PYZus{}SIZE}\PY{p}{)}\PY{p}{,}\PY{n}{mean} \PY{o}{=} \PY{n}{mu}\PY{p}{,} \PY{n}{stddev} \PY{o}{=} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv2\PYZus{}b} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{n}{LAYER2\PYZus{}SIZE}\PY{p}{]}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv2} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{conv2d}\PY{p}{(}\PY{n}{conv1}\PY{p}{,} \PY{n}{conv2\PYZus{}W}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{conv2\PYZus{}stride}\PY{p}{,} \PY{n}{conv2\PYZus{}stride}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{padding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{VALID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{o}{+} \PY{n}{conv2\PYZus{}b}
        
            \PY{c+c1}{\PYZsh{} TODO: Activation.}
            \PY{n}{conv2} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{relu}\PY{p}{(}\PY{n}{conv2}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} TODO: Pooling. Input = 10x10xLAYER2\PYZus{}SIZE. Output = 5x5xLAYER2\PYZus{}SIZE.}
            ...
            \PY{c+c1}{\PYZsh{} flat layer 2 for inter\PYZhy{}layer connection, using the structure from P. Sermanet and Y. LeCun}
            \PY{c+c1}{\PYZsh{} size is 400}
            \PY{n}{fc\PYZus{}layer2} \PY{o}{=} \PY{n}{flatten}\PY{p}{(}\PY{n}{conv2}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} lyaer 3: input = 5x5xLAYER2\PYZus{}SIZE, output = 1x1xLAYER3\PYZus{}SIZE}
            \PY{n}{conv3\PYZus{}stride} \PY{o}{=} \PY{l+m+mi}{1}
            \PY{n}{conv3\PYZus{}W} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{n}{shape}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{,}\PY{n}{LAYER2\PYZus{}SIZE}\PY{p}{,}\PY{n}{LAYER3\PYZus{}SIZE}\PY{p}{)}\PY{p}{,}\PY{n}{mean} \PY{o}{=} \PY{n}{mu}\PY{p}{,} \PY{n}{stddev} \PY{o}{=} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv3\PYZus{}b} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{n}{LAYER3\PYZus{}SIZE}\PY{p}{]}\PY{p}{)}\PY{p}{)}
            \PY{n}{conv3} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{conv2d}\PY{p}{(}\PY{n}{conv2}\PY{p}{,} \PY{n}{conv3\PYZus{}W}\PY{p}{,} \PY{n}{strides}\PY{o}{=}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{conv3\PYZus{}stride}\PY{p}{,} \PY{n}{conv3\PYZus{}stride}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{]}\PY{p}{,} \PY{n}{padding}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{VALID}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{o}{+} \PY{n}{conv3\PYZus{}b}
            ...
            \PY{n}{fc\PYZus{}layer3} \PY{o}{=} \PY{n}{flatten}\PY{p}{(}\PY{n}{conv3}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} add two layers together, the size is 800}
            \PY{n}{fc0} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{concat}\PY{p}{(}\PY{p}{[}\PY{n}{fc\PYZus{}layer2}\PY{p}{,} \PY{n}{fc\PYZus{}layer3}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{fc0 shape:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,}\PY{n}{fc0}\PY{o}{.}\PY{n}{get\PYZus{}shape}\PY{p}{(}\PY{p}{)}\PY{p}{)}
            
            \PY{c+c1}{\PYZsh{} add a dropout layer}
            \PY{n}{fc0} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{dropout}\PY{p}{(}\PY{n}{fc0}\PY{p}{,} \PY{n}{keep\PYZus{}prob}\PY{p}{)}
        
            \PY{c+c1}{\PYZsh{} TODO: Layer 3: Fully Connected. Input = 400. Output = 120.}
            \PY{c+c1}{\PYZsh{}fc1\PYZus{}W = tf.Variable(tf.truncated\PYZus{}normal(shape=(800, 120), mean = mu, stddev = sigma))}
            \PY{c+c1}{\PYZsh{}fc1\PYZus{}b = tf.Variable(tf.zeros([120]))}
            \PY{c+c1}{\PYZsh{}fc1 = tf.matmul(fc0, fc1\PYZus{}W) + fc1\PYZus{}b}
                        
            \PY{c+c1}{\PYZsh{} TODO: Activation.}
            \PY{c+c1}{\PYZsh{}fc1 = tf.nn.relu(fc1)}
        
            \PY{c+c1}{\PYZsh{} TODO: Layer 4: Fully Connected. Input = 120. Output = 84.}
            \PY{c+c1}{\PYZsh{}fc2\PYZus{}W = tf.Variable(tf.truncated\PYZus{}normal(shape=(120, 84), mean = mu, stddev = sigma))}
            \PY{c+c1}{\PYZsh{}fc2\PYZus{}b = tf.Variable(tf.zeros([84]))}
            \PY{c+c1}{\PYZsh{}fc2 = tf.matmul(fc1, fc2\PYZus{}W) + fc2\PYZus{}b    }
            \PY{c+c1}{\PYZsh{} TODO: Activation.}
            \PY{c+c1}{\PYZsh{}fc2 = tf.nn.relu(fc2)}
        
            \PY{c+c1}{\PYZsh{} TODO: Layer 5: Fully Connected. Input = 84. Output = n\PYZus{}classes.}
            \PY{n}{fc3\PYZus{}W} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{truncated\PYZus{}normal}\PY{p}{(}\PY{n}{shape}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{5}\PY{o}{*}\PY{l+m+mi}{5}\PY{o}{*}\PY{n}{LAYER2\PYZus{}SIZE}\PY{o}{+}\PY{n}{LAYER3\PYZus{}SIZE}\PY{p}{,} \PY{n}{n\PYZus{}classes}\PY{p}{)}\PY{p}{,} \PY{n}{mean} \PY{o}{=} \PY{n}{mu}\PY{p}{,} \PY{n}{stddev} \PY{o}{=} \PY{n}{sigma}\PY{p}{)}\PY{p}{)}
            \PY{n}{fc3\PYZus{}b} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{Variable}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{zeros}\PY{p}{(}\PY{p}{[}\PY{n}{n\PYZus{}classes}\PY{p}{]}\PY{p}{)}\PY{p}{)}
            \PY{n}{logits} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{matmul}\PY{p}{(}\PY{n}{fc0}\PY{p}{,} \PY{n}{fc3\PYZus{}W}\PY{p}{)} \PY{o}{+} \PY{n}{fc3\PYZus{}b}     
...
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Train your model here.}
        ...
        \PY{n}{rate} \PY{o}{=} \PY{l+m+mf}{0.0007}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
fc0 shape: (?, 2000)
WARNING:tensorflow:From <ipython-input-6-090fded7c7a4>:16: softmax\_cross\_entropy\_with\_logits (from tensorflow.python.ops.nn\_ops) is deprecated and will be removed in a future version.
...
Model saved
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}  
            \PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{tf}\PY{o}{.}\PY{n}{global\PYZus{}variables\PYZus{}initializer}\PY{p}{(}\PY{p}{)}\PY{p}{)}
            \PY{n}{saver2} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{train}\PY{o}{.}\PY{n}{import\PYZus{}meta\PYZus{}graph}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./lenet.meta}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
            \PY{n}{saver2}\PY{o}{.}\PY{n}{restore}\PY{p}{(}\PY{n}{sess}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./lenet}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}    
            \PY{n}{test\PYZus{}accuracy} \PY{o}{=} \PY{n}{evaluate}\PY{p}{(}\PY{n}{X\PYZus{}test\PYZus{}gray}\PY{p}{,} \PY{n}{y\PYZus{}test}\PY{p}{)} 
...
{\color{incolor}In [{\color{incolor}9}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Load the images and plot them here.}
        \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
        \PY{c+c1}{\PYZsh{} show image of 10 random data points}
        \PY{k+kn}{import} \PY{n+nn}{glob}\PY{o}{,} \PY{n+nn}{os}
        \PY{c+c1}{\PYZsh{} read all the images and convert to gray scale}
        \PY{n}{X\PYZus{}test2\PYZus{}gray} \PY{o}{=} \PY{p}{[}\PY{p}{]}
        
        \PY{n}{subplot\PYZus{}index} \PY{o}{=}\PY{l+m+mi}{1}\PY{p}{;}
        \PY{k}{for} \PY{n}{file} \PY{o+ow}{in} \PY{n}{glob}\PY{o}{.}\PY{n}{glob}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{./new\PYZus{}signs/*.png}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{:}
        \PY{c+c1}{\PYZsh{}for file in glob.glob(\PYZdq{}*.png\PYZdq{}):}
            \PY{c+c1}{\PYZsh{}print(file)}
            \PY{c+c1}{\PYZsh{}plt.subplot(1,9,subplot\PYZus{}index) }
            \PY{n}{img\PYZus{}x} \PY{o}{=} \PY{n}{plt}\PY{o}{.}\PY{n}{imread}\PY{p}{(}\PY{n}{file}\PY{p}{)}
            \PY{c+c1}{\PYZsh{}print(img\PYZus{}x.shape)}
            \PY{n}{X\PYZus{}test2\PYZus{}gray}\PY{o}{.}\PY{n}{append}\PY{p}{(}\PY{n}{color}\PY{o}{.}\PY{n}{rgb2gray}\PY{p}{(}\PY{n}{img\PYZus{}x}\PY{p}{)}\PY{o}{.}\PY{n}{reshape}\PY{p}{(}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{32}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
            \PY{c+c1}{\PYZsh{}plt.imshow(img\PYZus{}x)}
            \PY{c+c1}{\PYZsh{}subplot\PYZus{}index  +=1}
        
        \PY{n}{X\PYZus{}test2\PYZus{}gray} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{asarray}\PY{p}{(}\PY{n}{X\PYZus{}test2\PYZus{}gray}\PY{p}{)}
        
        \PY{c+c1}{\PYZsh{} normalized to +/\PYZhy{} 0.5}
        \PY{n}{X\PYZus{}test2\PYZus{}gray} \PY{o}{=} \PY{o}{\PYZhy{}}\PY{l+m+mf}{0.5} \PY{o}{+} \PY{p}{(}\PY{n}{X\PYZus{}test2\PYZus{}gray} \PY{p}{)}\PY{p}{;}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}\PY{p}{;}
        \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{X\PYZus{}test2\PYZus{}gray}\PY{p}{[}\PY{n}{subplot\PYZus{}index}\PY{p}{]}\PY{o}{.}\PY{n}{squeeze}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{cmap} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{gray}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}10}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Run the predictions here and use the model to output the prediction for each image.}
         ...
         \PY{n}{softmax\PYZus{}of\PYZus{}logits} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{softmax}\PY{p}{(}\PY{n}{logits}\PY{p}{)}
         \PY{n}{top\PYZus{}k} \PY{o}{=} \PY{n}{tf}\PY{o}{.}\PY{n}{nn}\PY{o}{.}\PY{n}{top\PYZus{}k}\PY{p}{(}\PY{n}{softmax\PYZus{}of\PYZus{}logits}\PY{p}{,} \PY{n}{k}\PY{o}{=}\PY{l+m+mi}{5}\PY{p}{)}
         ...
         \PY{k}{with} \PY{n}{tf}\PY{o}{.}\PY{n}{Session}\PY{p}{(}\PY{p}{)} \PY{k}{as} \PY{n}{sess}\PY{p}{:}  
             ...
             \PY{n}{my\PYZus{}top\PYZus{}k} \PY{o}{=} \PY{n}{sess}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{n}{top\PYZus{}k}\PY{p}{,} \PY{n}{feed\PYZus{}dict}\PY{o}{=}\PY{p}{\PYZob{}}\PY{n}{x}\PY{p}{:} \PY{n}{X\PYZus{}test2\PYZus{}gray}\PY{p}{,} \PY{n}{keep\PYZus{}prob}\PY{p}{:} \PY{l+m+mf}{1.0}\PY{p}{\PYZcb{}}\PY{p}{)}
...
\subsubsection{Analyze Performance}\label{analyze-performance}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Calculate the accuracy for these 5 new images. }
         ...
         \PY{c+c1}{\PYZsh{} plot out the image to verify the accuracy}
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}test2\PYZus{}gray}\PY{p}{)}\PY{p}{)}\PY{p}{:}
             \PY{n}{top\PYZus{}5\PYZus{}guess\PYZus{}labels} \PY{o}{=} \PY{n}{my\PYZus{}top\PYZus{}k}\PY{o}{.}\PY{n}{indices}\PY{p}{[}\PY{n}{i}\PY{p}{]}
             \PY{n}{top\PYZus{}1\PYZus{}guess\PYZus{}label\PYZus{}index} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{where}\PY{p}{(}\PY{n}{y\PYZus{}valid} \PY{o}{==} \PY{n}{top\PYZus{}5\PYZus{}guess\PYZus{}labels}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{)}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
             
             \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,}\PY{l+m+mi}{5}\PY{p}{)}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{1}\PY{p}{)} 
             \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{X\PYZus{}test2\PYZus{}gray}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{o}{.}\PY{n}{squeeze}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{cmap} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{gray}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
             
             \PY{n}{plt}\PY{o}{.}\PY{n}{subplot}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{,}\PY{l+m+mi}{2}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{imshow}\PY{p}{(}\PY{n}{X\PYZus{}valid\PYZus{}gray}\PY{p}{[}\PY{n}{top\PYZus{}1\PYZus{}guess\PYZus{}label\PYZus{}index}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}\PY{p}{]}\PY{o}{.}\PY{n}{squeeze}\PY{p}{(}\PY{p}{)}\PY{p}{,} \PY{n}{cmap} \PY{o}{=} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{gray}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
\end{Verbatim}
...
notice \texttt{{[}3,\ 0,\ 5{]}} are the corresponding indices.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}15}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Print out the top five softmax probabilities for the predictions on the German traffic sign images found on the web. }
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Feel free to use as many code cells as needed.}
         \PY{c+c1}{\PYZsh{} plot out the image to verify the accuracy}
         \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{X\PYZus{}test2\PYZus{}gray}\PY{p}{)}\PY{p}{)}\PY{p}{:}
             \PY{n}{top\PYZus{}5\PYZus{}guess\PYZus{}softmax} \PY{o}{=} \PY{n}{my\PYZus{}top\PYZus{}k}\PY{o}{.}\PY{n}{values}\PY{p}{[}\PY{n}{i}\PY{p}{]}
             \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{input image \PYZsh{}}\PY{l+s+si}{\PYZpc{}d}\PY{l+s+s1}{\PYZsq{}} \PY{o}{\PYZpc{}}\PY{k}{i})
             \PY{n+nb}{print}\PY{p}{(}\PY{n}{top\PYZus{}5\PYZus{}guess\PYZus{}softmax}\PY{p}{)}
\end{Verbatim}
